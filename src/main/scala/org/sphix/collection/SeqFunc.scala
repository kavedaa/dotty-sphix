...
abstract class SeqFunc[A](dependencies: jfxb.Observable*) extends ObservableSeqImpl[A] {
...
object SeqFunc {
  ...
  def apply[T1 <: O, T2 <: O, T3 <: O, T4 <: O, T5 <: O, T6 <: O, T7 <: O, T8 <: O, T9 <: O, T10 <: O, T11 <: O, R](o1: T1, o2: T2, o3: T3, o4: T4, o5: T5, o6: T6, o7: T7, o8: T8, o9: T9, o10: T10, o11: T11)(f: (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11) => Iterable[R]) =
    new SeqFunc[R](o1, o2, o3, o4, o5, o6, o7, o8, o9, o10, o11) {
      def compute = f(o1, o2, o3, o4, o5, o6, o7, o8, o9, o10, o11)
    }

  def apply[T1 <: O, T2 <: O, T3 <: O, T4 <: O, T5 <: O, T6 <: O, T7 <: O, T8 <: O, T9 <: O, T10 <: O, T11 <: O, T12 <: O, R](o1: T1, o2: T2, o3: T3, o4: T4, o5: T5, o6: T6, o7: T7, o8: T8, o9: T9, o10: T10, o11: T11, o12: T12)(f: (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12) => Iterable[R]) =
    new SeqFunc[R](o1, o2, o3, o4, o5, o6, o7, o8, o9, o10, o11, o12) {
      def compute = f(o1, o2, o3, o4, o5, o6, o7, o8, o9, o10, o11, o12)
    }

  def apply[T1 <: O, T2 <: O, T3 <: O, T4 <: O, T5 <: O, T6 <: O, T7 <: O, T8 <: O, T9 <: O, T10 <: O, T11 <: O, T12 <: O, T13 <: O, R](o1: T1, o2: T2, o3: T3, o4: T4, o5: T5, o6: T6, o7: T7, o8: T8, o9: T9, o10: T10, o11: T11, o12: T12, o13: T13)(f: (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13) => Iterable[R]) =
    new SeqFunc[R](o1, o2, o3, o4, o5, o6, o7, o8, o9, o10, o11, o12, o13) {
      def compute = f(o1, o2, o3, o4, o5, o6, o7, o8, o9, o10, o11, o12, o13)
    }
