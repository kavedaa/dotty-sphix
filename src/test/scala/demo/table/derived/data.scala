...
given Generator[Person] = (Generator.from(names), Generator.between(20, 80), Generator.between(10000L, 1500000L).map(BigDecimal.apply), Generator[Pet]).mapN(Person.apply)